...
const PhotoCard = ({ setMain, deletePhoto, profile, photoInfo }) => {
    ...
    return (
        ...
        >
            ...
            />
            <CardActions>
                <Button className="main-btn" disabled={isMain} onClick={handleSetMain} size="small" color="primary">
                    Main
                </Button>
                <Button className="delete-btn" onClick={handleDeletePhoto} size="small" color="primary">
                    Delete
                </Button>
            </CardActions>
        </Card>
